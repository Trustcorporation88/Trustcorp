...
const PRODUCTS = [
  ...
  { id:"xls-financeiro", tk:"XF1", name:"Diagnóstico Financeiro 360", pil:"prod", label:"Produtividade",
    desc:"Score 0–100, cascata do mês, sparklines, projeção de patrimônio e radar.",
  ...
  { id:"xls-fluxo", tk:"XF2", name:"Simulador de Fluxo de Caixa 90d", pil:"prod", label:"Produtividade",
    desc:"Cenários, cascata de caixa 90d, sparklines, runway e ponto de ruptura.",
  ...
  { id:"xls-metas", tk:"XF3", name:"Painel OKR & Hábitos", pil:"prod", label:"Produtividade",
    desc:"Previsão por ritmo, cascata de gap, sparklines e radar de hábitos.",
  ...
  { id:"xls-cobrancas", tk:"XF4", name:"Régua de Cobrança Inteligente", pil:"prod", label:"Produtividade",
    desc:"DSO, cascata da carteira, aging com spark, recuperação esperada e ação.",
  ...
  { id:"xls-preco", tk:"XF5", name:"Motor de Precificação", pil:"prod", label:"Produtividade",
    desc:"Valor/hora, cascata custo→preço, break-even, margem e 3 cenários.",
  ...
  { id:"xls-kanban", tk:"XF6", name:"Cockpit de Produtividade", pil:"prod", label:"Produtividade",
    desc:"Cascata de fluxo, throughput, cycle time, WIP, burndown spark e alertas.",
