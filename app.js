...
const PRODUCTS = [
  ...
  { id:"xls-financeiro", tk:"XF1", name:"Diagnóstico Financeiro 360", pil:"prod", label:"Produtividade",
    desc:"Score de saúde financeira 0–100, projeção de patrimônio, raio-X em radar e alertas.",
    url:"https://excel.trustcorp.com.br/planilhas/01_diagnostico_financeiro_360.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo", also:["empresas"] },
  { id:"xls-fluxo", tk:"XF2", name:"Simulador de Fluxo de Caixa 90d", pil:"prod", label:"Produtividade",
    desc:"Cenários pessimista/realista/otimista, runway em dias e ponto de ruptura automático.",
    url:"https://excel.trustcorp.com.br/planilhas/02_simulador_fluxo_caixa_90d.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo", also:["empresas"] },
  { id:"xls-metas", tk:"XF3", name:"Painel OKR & Hábitos", pil:"prod", label:"Produtividade",
    desc:"Previsão de atingimento por ritmo, burn-up de OKRs e consistência de hábitos em radar.",
    url:"https://excel.trustcorp.com.br/planilhas/03_painel_okr_habitos.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo" },
  { id:"xls-cobrancas", tk:"XF4", name:"Régua de Cobrança Inteligente", pil:"prod", label:"Produtividade",
    desc:"DSO, aging por faixa, recuperação esperada ponderada por risco e ação sugerida.",
    url:"https://excel.trustcorp.com.br/planilhas/04_regua_cobranca_inteligente.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo", also:["empresas"] },
  { id:"xls-preco", tk:"XF5", name:"Motor de Precificação", pil:"prod", label:"Produtividade",
    desc:"Valor/hora, ponto de equilíbrio com gráfico, margem de contribuição e 3 cenários.",
    url:"https://excel.trustcorp.com.br/planilhas/05_motor_precificacao.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo", also:["empresas"] },
  { id:"xls-kanban", tk:"XF6", name:"Cockpit de Produtividade", pil:"prod", label:"Produtividade",
    desc:"Throughput, cycle time, WIP, burndown e alertas de tarefas envelhecidas.",
    url:"https://excel.trustcorp.com.br/planilhas/06_cockpit_produtividade.xlsx", domain:"excel.trustcorp.com.br/planilhas", status:"ativo" },
  { id:"xls-relatorio", tk:"XF7", name:"BI Executivo do Negócio", pil:"prod", label:"Produtividade",
    desc:"MRR, crescimento, churn, CAC, LTV e LTV/CAC com leitura executiva automática.",
